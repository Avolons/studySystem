...
var App = new Vue({
    ...
    methods: {
        //******答案格式化
        listFormatting: function listFormatting(arrys) {
    ...
    mounted: function mounted() {
        ...
        //模拟的假数据
        this.$http.get("http://192.168.1.102/home/GetUserExamChart").then(function (data) {
            _this.scoreList = data.body;
            _this.topSel();
            _this.$http.get("http://192.168.1.102/home/GetExamInfoHaveAnswer").then(function (data) {
                _this.qstData = data.body;
                _this.listFormatting(_this.qstData.QuestionsItems);
                layer.close(index);
            }, function (error) {});
        }, function (error) {});
    }
